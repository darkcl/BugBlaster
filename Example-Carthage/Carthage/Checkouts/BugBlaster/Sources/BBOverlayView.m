...
{
    if ([self.delegate respondsToSelector:@selector(overlayViewReceicedTap:)]) {
        [self.delegate overlayViewReceicedTap:self];
    }
}
...
- (void)bugWasDoubleTapped:(id)sender
{
    ...
    if ([self.delegate respondsToSelector:@selector(overlayViewReceicedDoubleTap:)]) {
        [self.delegate overlayViewReceicedDoubleTap:self];
    }
}
